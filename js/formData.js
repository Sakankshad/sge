$( document ).ready(function( $ ) {
	...
	$("#reused_form").submit(function(event){
		...
		request = $.ajax({
			url: "https://script.google.com/macros/s/AKfycbzTZGHgBnUK9KAAcQeTGoXkk_JGljChoWmhjuon9sYNzPCIFPOriw-HehAGhX4sDBetNg/exec",
			type: "get",
			data: serializedData
		});
		...
		request.done(function (response, textStatus, jqXHR){
			...
			alert("Submitted! We will contact you soon. For urgent queries call +91 933 446 9140");
		});
