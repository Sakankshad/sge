...
! function(e, t) {
        ...
        if (e)
            if ("string" == typeof e) {
                ...
                if (d.indexOf("<") >= 0 && d.indexOf(">") >= 0) {
                    var p = "div";
                    for (0 === d.indexOf("<li") && (p = "ul"), 0 === d.indexOf("<tr") && (p = "tbody"), 0 !== d.indexOf("<td") && 0 !== d.indexOf("<th") || (p = "tr"), 0 === d.indexOf("<tbody") && (p = "table"), 0 === d.indexOf("<option") && (p = "select"), (l = r.createElement(p)).innerHTML = d, i = 0; i < l.childNodes.length; i += 1) a.push(l.childNodes[i])
                } else
    ...
    var i, s, r = i = "undefined" == typeof document ? {
            body: {},
            ...
            for (var i = t[0].split(" "), s = t[1], o = 0; o < i.length; o += 1)
                for (var l = 0; l < this.length; l += 1) {
                    ...
                    e[l].dom7EventData = t.filter(function(e, t) {
                        return t > 0
                    }), e[l].dispatchEvent(d), e[l].dom7EventData = [], delete e[l].dom7EventData
                }
            return this
        },
            ...
            for (var i, s = 0; s < t.length; s += 1) {
                ...
                for (var n = 0; n < this.length; n += 1)
                    if ("string" == typeof i) {
                        ...
                        for (l.innerHTML = i; l.firstChild;) e[n].appendChild(l.firstChild)
    ...
    var h = {
            ...
            updateSlides: function() {
                ...
                if (void 0 !== i) {
                    ...
                    for (var T, S = t.slidesPerColumn, C = E / S, M = C - (t.slidesPerColumn * C - o), z = 0; z < o; z += 1) {
                        ...
                        if (t.slidesPerColumn > 1) {
                            var k = void 0,
                                $ = void 0,
                                L = void 0;
                            "column" === t.slidesPerColumnFill ? (L = z - ($ = Math.floor(z / S)) * S, ($ > M || $ === M && L === S - 1) && (L += 1) >= S && (L = 0, $ += 1), k = $ + L * E / S, P.css({
                    ...
                    0 === l.length && (l = [0]), 0 !== t.spaceBetween && (e.isHorizontal() ? s ? n.css({
                        marginLeft: b + "px"
                    }) : n.css({
                        marginRight: b + "px"
                    }) : n.css({
                        ...
                        slidesGrid: c,
                        slidesSizesGrid: u
                    }), o !== f && e.emit("slidesLengthChange"), l.length !== m && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), c.length !== g && e.emit("slidesGridLengthChange"), (t.watchSlidesProgress || t.watchSlidesVisibility) && e.updateSlidesOffset()
                }
            },
            ...
            updateProgress: function(e) {
                ...
                var t = this,
                    ...
                    o = r,
                    l = n;
                0 === i ? (s = 0, r = !0, n = !0) : (r = (s = (e - t.minTranslate()) / i) <= 0, n = s >= 1), d.extend(t, {
                    progress: s,
                    isBeginning: r,
                    isEnd: n
        ...
        m = {
            ...
            slideToClickedSlide: function() {
                ...
                if (i.loop) {
                    ...
                    t = parseInt(e(a.clickedSlide).attr("data-swiper-slide-index"), 10), i.centeredSlides ? n < a.loopedSlides - r / 2 || n > a.slides.length - a.loopedSlides + r / 2 ? (a.loopFix(), n = s.children("." + i.slideClass + '[data-swiper-slide-index="' + t + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), d.nextTick(function() {
                        a.slideTo(n)
                    })) : a.slideTo(n) : n > a.slides.length - r ? (a.loopFix(), n = s.children("." + i.slideClass + '[data-swiper-slide-index="' + t + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), d.nextTick(function() {
                        a.slideTo(n)
                    })) : a.slideTo(n)
                } else a.slideTo(n)
            }
                ...
                if (l.originalEvent && (l = l.originalEvent), i.isTouchEvent = "touchstart" === l.type, (i.isTouchEvent || !("which" in l) || 3 !== l.which) && (!i.isTouched || !i.isMoved))
                    ...
                    if (!(y.ios && !y.cordova && s.iOSEdgeSwipeDetection && p <= s.iOSEdgeSwipeThreshold && p >= n.screen.width - s.iOSEdgeSwipeThreshold)) {
                        if (d.extend(i, {
                                ...
                                isScrolling: void 0,
                                startMoving: void 0
                            }), o.startX = p, o.startY = c, i.touchStartTime = d.now(), a.allowClick = !0, a.updateSize(), a.swipeDirection = void 0, s.threshold > 0 && (i.allowThresholdMove = !1), "touchstart" !== l.type) {
                            var u = !0;
        ...
        E = function(t) {
            ...
            if (l.originalEvent && (l = l.originalEvent), i.isTouched) {
                if (!i.isTouchEvent || "mousemove" !== l.type) {
                    ...
                    if (!a.allowTouchMove) return a.allowClick = !1, void(i.isTouched && (d.extend(n, {
                        startX: p,
                        startY: c,
                        currentX: p,
                        currentY: c
        ...
        T = function(e) {
            ...
            if (t.allowClick && (t.updateClickedSlide(p), t.emit("tap", p), u < 300 && c - a.lastClickTime > 300 && (a.clickTimeout && clearTimeout(a.clickTimeout), a.clickTimeout = d.nextTick(function() {
                    t && !t.destroyed && t.emit("click", p)
                }, 300)), u < 300 && c - a.lastClickTime < 300 && (a.clickTimeout && clearTimeout(a.clickTimeout), t.emit("doubleTap", p))), a.lastClickTime = d.now(), d.nextTick(function() {
        ...
        M = {
            attachEvents: function() {
                ...
                if (p.touch || !p.pointerEvents && !p.prefixedPointerEvents) {
                    if (p.touch) {
                        var l = !("touchstart" !== a.start || !p.passiveListener || !t.passiveListeners) && {
                            passive: !0,
                            capture: !1
                        };
                        n.addEventListener(a.start, e.onTouchStart, l), n.addEventListener(a.move, e.onTouchMove, p.passiveListener ? {
                            passive: !1,
                            capture: o
                        } : o), n.addEventListener(a.end, e.onTouchEnd, l)
            ...
            detachEvents: function() {
                ...
                if (p.touch || !p.pointerEvents && !p.prefixedPointerEvents) {
                    if (p.touch) {
                        var l = !("onTouchStart" !== a.start || !p.passiveListener || !t.passiveListeners) && {
                            passive: !0,
                            capture: !1
                        };
            ...
            setBreakpoint: function() {
                ...
                if (s && (!s || 0 !== Object.keys(s).length)) {
                    ...
                    if (r && e.currentBreakpoint !== r) {
                        ...
                        d.extend(e.params, n), d.extend(e, {
            ...
            classes: {
                addClasses: function() {
                    var e = this,
                        ...
                        s = e.$el,
                        r = [];
                    r.push(a.direction), a.freeMode && r.push("free-mode"), p.flexbox || r.push("no-flexbox"), a.autoHeight && r.push("autoheight"), i && r.push("rtl"), a.slidesPerColumn > 1 && r.push("multirow"), y.android && r.push("android"), y.ios && r.push("ios"), P.isIE && (p.pointerEvents || p.prefixedPointerEvents) && r.push("wp8-" + a.direction), r.forEach(function(e) {
        ...
        I = function(t) {
            function a() {
                ...
                n || (n = {}), n = d.extend({}, n), r && !n.el && (n.el = r), t.call(this, n), Object.keys($).forEach(function(e) {
                ...
                if (r = u[0]) {
                    ...
                    return d.extend(l, {
                        ...
                        touchEvents: function() {
                            ...
                            return p.pointerEvents ? t = ["pointerdown", "pointermove", "pointerup"] : p.prefixedPointerEvents && (t = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), l.touchEventsTouch = {
                                start: e[0],
                                move: e[1],
                                end: e[2]
            ...
            return a.prototype.slidesPerViewDynamic = function() {
                ...
                a.emit("beforeDestroy"), a.initialized = !1, a.detachEvents(), i.loop && a.loopDestroy(), t && (a.removeClasses(), s.removeAttr("style"), r.removeAttr("style"), n && n.length && n.removeClass([i.slideVisibleClass, i.slideActiveClass, i.slideNextClass, i.slidePrevClass].join(" ")).removeAttr("style").removeAttr("data-swiper-slide-index").removeAttr("data-swiper-column").removeAttr("data-swiper-row")), a.emit("destroy"), Object.keys(a.eventsListeners).forEach(function(e) {
                    a.off(e)
                }), !1 !== e && (a.$el[0].swiper = null, a.$el.data("swiper", null), d.deleteProps(a)), a.destroyed = !0
        ...
        Y = {
            update: function(e) {
                ...
                if (d.extend(a.virtual, {
                        from: w,
                        to: y,
                        offset: x,
                        slidesGrid: a.slidesGrid
                    }), l === w && p === y && !e) return a.slidesGrid !== u && x !== v && a.slides.css(f, x + "px"), void a.updateProgress();
        ...
        R = {
            ...
            handle: function(e) {
                ...
                if (i.invert && (s = -s), a.params.freeMode) {
                    var l = a.getTranslate() + s * i.sensitivity,
                        p = a.isBeginning,
                        c = a.isEnd;
                    if (l >= a.minTranslate() && (l = a.minTranslate()), l <= a.maxTranslate() && (l = a.maxTranslate()), a.setTransition(0), a.setTranslate(l), a.updateProgress(), a.updateActiveIndex(), a.updateSlidesClasses(), (!p && a.isBeginning || !c && a.isEnd) && a.updateSlidesClasses(), a.params.freeModeSticky && (clearTimeout(a.mousewheel.timeout), a.mousewheel.timeout = d.nextTick(function() {
                            a.slideReset()
                        }, 300)), a.emit("scroll", t), a.params.autoplay && a.params.autoplayDisableOnInteraction && a.stopAutoplay(), l === a.minTranslate() || l === a.maxTranslate()) return !0
                } else {
            ...
            enable: function() {
                ...
                var a = t.$el;
                return "container" !== t.params.mousewheel.eventsTarged && (a = e(t.params.mousewheel.eventsTarged)), a.on(R.event, t.mousewheel.handle), t.mousewheel.enabled = !0, !0
            },
            disable: function() {
                var t = this;
                if (!R.event) return !1;
                if (!t.mousewheel.enabled) return !1;
                var a = t.$el;
                return "container" !== t.params.mousewheel.eventsTarged && (a = e(t.params.mousewheel.eventsTarged)), a.off(R.event, t.mousewheel.handle), t.mousewheel.enabled = !1, !0
            }
        },
        F = {
            update: function() {
        ...
        q = {
            ...
            updateSize: function() {
                ...
                if (e.params.scrollbar.el && e.scrollbar.el) {
                    ...
                    var s, r = e.isHorizontal() ? i[0].offsetWidth : i[0].offsetHeight,
                        ...
                        o = n * (r / e.size);
                    s = "auto" === e.params.scrollbar.dragSize ? r * n : parseInt(e.params.scrollbar.dragSize, 10), e.isHorizontal() ? a[0].style.width = s + "px" : a[0].style.height = s + "px", i[0].style.display = n >= 1 ? "none" : "", e.params.scrollbarHide && (i[0].style.opacity = 0), d.extend(t, {
                        trackSize: r,
                        divider: n,
                        moveDivider: o,
                        dragSize: s
            ...
            init: function() {
                ...
                if (t.params.scrollbar.el) {
                    ...
                    0 === n.length && (n = e('<div class="' + t.params.scrollbar.dragClass + '"></div>'), r.append(n)), d.extend(a, {
                        $el: r,
                        el: r[0],
                        $dragEl: n,
                        dragEl: n[0]
        ...
        Q = {
            ...
            setHistory: function(e, t) {
                ...
                if (a.history.initialized && a.params.history.enabled) {
                    ...
                    r && r.value === s || (a.params.history.replaceState ? n.history.replaceState({
                        value: s
...
! function(e) {
    ...
    }, "undefined" != typeof module && module.exports ? module.exports = o : void 0 === e || e.Promise || (e.Promise = o), window.Promise || (window.Promise = o)
}(this);
